...
public class EnvironmentTmp
{
    ...
    public EnvironmentTmp(ClassLoader classLoader)
    {
        this.classLoader = classLoader;
        annotationDatabase = new AnnotationDatabaseImpl(classLoader);
    }

    public EnvironmentTmp()
    {
        classLoader = EnvironmentTmp.class.getClassLoader();
        annotationDatabase = new AnnotationDatabaseImpl(classLoader);
    }
    ...
    public static class ReadOnlyEnvironment
    {
        ...
        private final   EnvironmentTmp              host;

        public ReadOnlyEnvironment(EnvironmentTmp host)
        {
            this.host = host;
