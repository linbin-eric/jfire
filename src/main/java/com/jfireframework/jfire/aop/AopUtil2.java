...
public class AopUtil2
{
    ...
    private final Map<String, BeanAopDefinition> beanAopDefinitions = new HashMap<String, AopUtil2.BeanAopDefinition>();
    private final AnnotationUtil                 annotationUtil;
    
    public AopUtil2(ClassLoader classLoader, AnnotationUtil annotationUtil)
    {
     ...
     * @throws CannotCompileException
     */
    private void addTxToMethod(CompilerModel compilerModel, String txFieldName, List<Method> txMethods) throws NotFoundException, CannotCompileException
    {
     ...
     * @throws CannotCompileException
     */
    private void addResToMethod(CompilerModel compilerModel, String resFieldName, List<Method> resMethods) throws NotFoundException, CannotCompileException
    {
    ...
    private void addCacheToMethod(CompilerModel compilerModel, String cacheFieldName, List<Method> cacheMethods) throws CannotCompileException, NotFoundException
    {
