...
import cc.jfire.jfire.core.aop.notated.cache.CacheDelete;
import cc.jfire.jfire.core.aop.notated.cache.CacheGet;
import cc.jfire.jfire.core.aop.notated.cache.CachePut;
...
public class CacheEnhanceManager implements EnhanceManager
{
    ...
    {
        /**
         * 获取指定名称的缓存，如果没有找到对应名称的缓存，抛出空指针异常
         *
         * @param name 缓存名称
         * @return 缓存实例
         */
