...
public class TxManager extends JdbcTransactionManager
{
    ...
    public static class TxTestDataSource implements DataSource
    {
        @Override
        public Connection getConnection() throws SQLException
        {
            return new TxTestConnection();
        }
    ...
    public static class TxTestConnection implements Connection
    {
